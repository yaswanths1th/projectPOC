...
export default function AIChat() {
  ...
  useEffect(() => {
    ...
    const doRefresh = async () => {
      try {
        ...
        setEffectiveUser(res.data);
        setCanUseAI(detectCanUseAI(res.data));
      } catch {}
    };
    ...
    const loadSessions = async () => {
      try {
        ...
        if (!activeSessionId && list.length > 0) {
          ...
          loadMessagesForSession(firstId, token);
        }
      } catch {}
    };
  ...
  // ✅ handleSend, renderBubble, JSX, buttons, classes — untouched

  // ⬇️ keep the rest of your original file exactly as-is
