      ...
      <header className="lp-navbar">
        ...
        >
          ...
          <div className="lp-logo-text">
            <span className="lp-logo-title">APTi WFM Suite</span>
      ...
      <main className="lp-main">
        <section className="lp-hero">
          <div className="lp-hero-text">
            ...
            <p>
              APTi WFM HR Suite automates attendance, payroll, performance, and
        ...
        <section id="how-it-works" className="lp-section lp-how">
          <h2>How APTi WFM HR Suite works</h2>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-left">
          <span className="lp-footer-brand">
            © {new Date().getFullYear()} APTi WFM HR Suite.
          </span>
